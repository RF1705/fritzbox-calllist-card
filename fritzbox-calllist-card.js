...
const TRANSLATIONS = {
  ...
  pl: {
    ...
    notAnswered: "Nie osiagnieto",
    errorEntity: "Podaj encje FRITZ!Box Calllist.",
    editorEntity: "Encja",
    editorTitle: "Tytul",
    editorMaxItems: "Wpisy",
    editorFontSize: "Rozmiar czcionki",
    editorNameFormat: "Format nazwy",
    nameFormatFirstLast: "Imie Nazwisko",
    nameFormatLastFirst: "Nazwisko Imie",
    cardDescription: "Pokazuje polaczenia na zywo i historie z FRITZ!Box Calllist.",
  },
  cs: {
    empty: "Zadne hovory",
    unknown: "Neznamy",
    ...
    notAnswered: "Nedovolano",
    errorEntity: "Zadejte entitu FRITZ!Box Calllist.",
    editorEntity: "Entita",
    editorTitle: "Titulek",
    editorMaxItems: "Zaznamy",
    editorFontSize: "Velikost pisma",
    editorNameFormat: "Format jmena",
    nameFormatFirstLast: "Jmeno Prijmeni",
    nameFormatLastFirst: "Prijmeni Jmeno",
    cardDescription: "Zobrazuje zive hovory a historii z FRITZ!Box Calllist.",
  },
};
